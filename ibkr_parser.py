        ...
        for sor in csv_olvaso:
            ...
            if (
                ...
                tranzakcio = {
                    ...
                    "mennyiseg": abs(elojeles_mennyiseg),
                    "elojeles_mennyiseg": elojeles_mennyiseg,
                    "ar": float(sor[8]),
                ...
                tranzakciok.append(tranzakcio)

    tranzakciok_df = pd.DataFrame(tranzakciok)
